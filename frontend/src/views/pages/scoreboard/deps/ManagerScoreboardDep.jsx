import {ArrowUpOutlined, DollarCircleOutlined,LineChartOutlined,PercentageOutlined,ReloadOutlined,TrophyOutlined,UserOutlined} from "@ant-design/icons";
import {Alert,Button,Card,Col,Divider,Flex,Progress,Row,Space,Statistic,Table,Tag,Tooltip,Typography,} from "antd";
    ...
    <>
     {isError ? (
        ...
        <Card
          ...
          styles={{header:{padding:'18px 22px 6px'}, body:{padding:'12px 22px 22px'}}}
          title={
            <Space>
                    ...
                    <Row gutter={[10, 10]}>
                        <Col span={6}>
                           <Card variant="borderless">
                             <Statistic title="Active" value={11.28} precision={2} styles={{ content: { color: '#3f8600' } }} prefix={<ArrowUpOutlined />} suffix="%"/>
                          </Card>
                        </Col>
                        <Col span={6}> 
                             <Card variant="borderless">
